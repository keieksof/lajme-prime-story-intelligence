...
type RelatedItem = Record<string, unknown> & { video_id?: string; title?: string; relationship_type?: string; score?: number; url?: string }
...
function App() {
  ...
  async function analyzeCurrent() {
    ...
    try {
      ...
      setAnalysis(result); patchStage('analyze', 'done'); if (result.graph) patchStage('graph', 'done'); setSelectedStage('analyze'); setMessage('Story Intelligence u përfundua dhe historia u lidh me graph-in.')
    } catch (error) {
